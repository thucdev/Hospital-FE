...
const getSpecialtyById = (id) => {
   return axios.get(`/v1/api/get-specialty-by-id/?id=${id}`)
}
...
const getDoctorById = (id) => {
   return axios.get(`/v1/api/get-doctor-by-id/?id=${id}`)
}
...
const createAppointment = (data) => {
   return axios.post(`/v1/api/create-an-appointment`, data)
}
...
const checkIsEmailExist = (email) => {
   return axiosJWT.post("/v1/api/is-email-exist", email, setHeader())
}
